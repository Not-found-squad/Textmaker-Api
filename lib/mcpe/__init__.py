...
class tulis:
    ...
    def __init__(self, listOrText):
        ...
        self.output = []
    def tulis(self):
        img, font, kata, tempkata=Image.open("lib/textmaker/mcpe/mcj.jpg"), ImageFont.truetype("lib/textmaker/mcpe/mencret.ttf",55),'',''
        ...
        line=115
        for i in spliter[:56]:
            draw.text((70, int(line)), i, font=font, fill=("#d1d1d1")) #selisih = Line
            line+=85 + 4.0
